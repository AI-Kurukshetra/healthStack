...
export default function RegisterPage() {
  return (
    <div className="relative grid min-h-svh w-full overflow-hidden bg-[#f8f4ef] md:grid-cols-2">
      ...
      <section className="hidden bg-cyan-950 p-10 text-slate-100 md:flex md:flex-col md:justify-between">
        ...
        <Link
          href="/"
          className="inline-flex w-fit rounded-full border border-cyan-700 px-4 py-2 text-sm transition hover:border-cyan-300 hover:text-cyan-100"
        >
