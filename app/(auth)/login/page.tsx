      ...
      <section className="hidden bg-slate-900 p-10 text-slate-100 md:flex md:flex-col md:justify-between">
        <div className="space-y-4">
          ...
          <h1 className="text-4xl font-semibold leading-tight">
            Welcome back to your virtual care workspace.
          </h1>
          <p className="max-w-md text-sm text-slate-300">
            Manage patient onboarding, scheduling, encounters, and clinical
            records from one secure dashboard.
          </p>
        </div>
        <Link
          href="/"
          className="inline-flex w-fit rounded-full border border-slate-600 px-4 py-2 text-sm transition hover:border-cyan-300 hover:text-cyan-200"
        >
